                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                if ($rows > 0) {
                                    ...
                                    $sql = "SELECT*FROM saw_penilaian ORDER BY kehadiran DESC";
                                    $hasil = $conn->query($sql);
                                    $row = $hasil->fetch_row();
                                    $C1 = $row[1];
                                    $sql = "SELECT*FROM saw_penilaian ORDER BY loyalitas DESC";
                                    $hasil = $conn->query($sql);
                                    $row = $hasil->fetch_row();
                                    $C2 = $row[2];
                                    $sql = "SELECT*FROM saw_penilaian ORDER BY teamwork DESC";
                                    $hasil = $conn->query($sql);
                                    $row = $hasil->fetch_row();
                                    $C3 = $row[3];
                                    $sql = "SELECT*FROM saw_penilaian ORDER BY kedisiplinan DESC";
                                    $hasil = $conn->query($sql);
                                    $row = $hasil->fetch_row();
                                    $C4 = $row[4];
                                    $sql = "SELECT*FROM saw_penilaian ORDER BY kreativitas DESC";
                                    $hasil = $conn->query($sql);
                                    $row = $hasil->fetch_row();
                                    $C5 = $row[5];
                                    $sql = "SELECT*FROM saw_penilaian ORDER BY masakerja DESC";
                                    $hasil = $conn->query($sql);
                                    $row = $hasil->fetch_row();
                                    $C6 = $row[6];
                                } else {
